...
R code developed as part of the manuscript "Dog days are over...cat ones still ongoing! Domestic cats are a most serious threat to native biodiversity in a Mediterranean country Mori et al. (2019) Frontiers in Ecology and Evolution, 7, 477. A copy of the main script (AnalysesCats.R) is shown below. 
